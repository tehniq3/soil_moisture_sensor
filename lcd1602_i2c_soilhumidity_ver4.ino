...
// versiune pentru udare, 30.07.2016
// versiune indicate timp scurs de la ultima udare, 02.07.2016
// versiune pentru 4 zone de control, 06.07.2016
// versiune pentru schimbare din jumper pentru relee comandate normal sau invers, 30.07.2016
...
pinMode(pinjumper, INPUT);      // selectie comanda relee
digitalWrite(pinjumper, HIGH);  // puns intrare in 1 logic
...
lcd.print("Moisture control"); // afisare text
lcd.setCursor(3, 1);   // mutare cursor pe coloana a 2-a din stanga - jos
lcd.print("in 4 zones"); // afisare text
...
//jumper = 1;     // intrare in gol (logica normala)
if (digitalRead(pinjumper) == HIGH) jumper = 1;
else jumper = 0;
}
